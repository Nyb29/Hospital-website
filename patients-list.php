...
// cleaning and sanitising input  while showing the booking
//from line 63 we have the choice to delete the patient and the booking
    ...
    <table>
        ...
        <?php foreach ($bookings as $booking){?>
                <tr>
                    ...
                    <td>
                        <a class="actionButton" href="deleteBooking.php?bid=<?php echo $booking['id']; ?>">Delete Booking</a>
                        <a class="actionButton" href="deletePatient.php?pid=<?php echo $booking['patientID']; ?>">Delete Patient</a>
                    </td>
                </tr>
            <?php } ?>
    </table>
